...
class Stranger
{
  ...
  public function execMigration()
  {
    ...
    try {
      ...
      if (isset($this->argv[2]) && $versions[0] == 'version') {
        ...
        $migrate_classes = $migrate->where('version', '>', $versions[1])
          ->desc('version')
          ->find('all');
  ...
  protected function geterateColumnString($argv)
  {
    ...
    for ($i = 4; $i < count($argv); $i ++) {
      ...
      $column_string .= "              <div class='row'>\n";
      $column_string .= "                <div class='col-sm-12 col-md-12 col-lg-4 col-xl-4'>\n";
      $column_string .= "                  " . $this->class_name . " " . $datas['column_name'] . "\n";
      $column_string .= "                </div>\n";
      $column_string .= "                <div class='col-sm-12 col-md-12 col-lg-8 col-xl-8'>\n";
